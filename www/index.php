...
Далі в index.php оприділяємо назву контролера та його ім'я функції яка сформує на м сторінку.
І викликаємо loadPage() для формування сторінки, 1-об'єк смарті з config.php, 2 - ім'я контролера 3 - ім'я функції
В  mainFunction.php ми бачимо загрузку нашого контроллера оприділяємо функцію та викликаємо її
...
В  mainFunction.php викликається loadTemplate яка опрацьовує шаблон і виводить його на екран
*/
