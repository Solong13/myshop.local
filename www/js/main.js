...
function addToCart(itemId){
    ...
    $.ajax({
		type: 'POST',
		// не асинхронна передача
		async: false,
		// урл куди ми звертаємося + що передаємо
		url: "/cart/addtocart/" + itemId + '/',
		// тип даних
		dataType: 'json',
		//  при успіху викон функція
		success: function(data){
			// массив даних
			if(data['success']){
				// змінює кількість значень в корзині
                $('#cartCntItems').html(data['cntItems']);

				// або ховаєм або показуємо клас з нашим айді продукта
